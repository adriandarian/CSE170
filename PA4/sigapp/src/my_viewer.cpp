...
int MyViewer::handle_keyboard(const GsEvent& e)
{
	...
	switch (e.key)
	{
	case 'q': {++numFaces; rootg()->remove_all(); build_scene(); render(); return 1; }//+nubmer of faces
	case 'a': {--numFaces; rootg()->remove_all(); build_scene(); render(); return 1; }
	case 'w': {r += 0.1f; rootg()->remove_all(); build_scene(); render(); return 1; }
	case 's': {r -= 0.1f; rootg()->remove_all(); build_scene(); render(); return 1; }
	case 'e': {R += 0.1f; rootg()->remove_all(); build_scene(); render(); return 1; }
	case 'd': {R -= 0.1f; rootg()->remove_all(); build_scene(); render(); return 1; }
	case 'z': {flat = true; rootg()->remove_all(); build_scene(); render(); return 1; }// Flat
	case 'x': {flat = false; rootg()->remove_all(); build_scene(); render(); return 1; }// Smooth
	case 'c': {compute_segments(flat); build_scene(); render(); return 1; } //normal
	case 'v': {rootg()->remove_all(); build_scene(); render(); return 1; } // clear all
